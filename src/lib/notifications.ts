...
export async function notifyWelcome(userEmail: string, userName: string) {
  return sendEmail({
    to: userEmail,
    subject: '🎉 Welcome to ClickNsit!',
    html: baseTemplate(
      'Welcome to ClickNsit!',
      `<p style="color:#374151;font-size:15px;">Hi <strong>${userName}</strong>,</p>
      <p style="color:#374151;font-size:15px;">Welcome to <strong style="color:#1B2559;">ClickNsit</strong> — your online cyber cafe for form filling!</p>
