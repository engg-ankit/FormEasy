      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-neutral max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-neutral-600 leading-relaxed">For any privacy-related concerns, contact us at <strong>privacy@formeasy.com</strong> or call <strong>+91 9650X XXX95</strong>.</p>
          </section>
        </div>
      </div>
    </div>
