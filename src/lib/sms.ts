 ...
 * - NEXT_PUBLIC_APP_URL: Your app URL (e.g., https://clickandsit.in)
 */
...
export async function sendOtpRelaySms(
  ...
  const message = `ClickNsit: Your ${portalName} form is being filled. Please share OTP here: ${otpLink}`;
