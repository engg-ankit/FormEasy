    ...
    return (
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-neutral-600 dark:text-neutral-300 dark:text-neutral-300">Loading application details...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
        <nav className="bg-white dark:bg-neutral-800 shadow-sm border-b border-neutral-200 dark:border-neutral-700 dark:border-neutral-700 dark:border-neutral-700">
        ...
        <div className="max-w-3xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 mb-6">{error}</p>
          <Link href="/dashboard">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 mt-1 text-sm">
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              <div className="flex justify-between items-center mb-3">
                <span className="text-sm font-medium text-neutral-600 dark:text-neutral-300 dark:text-neutral-300">Overall Progress</span>
                    ...
                    return (
                      <div key={step.status} className="flex flex-col items-center flex-1 relative">
                        ...
                        <span className={`text-[10px] text-center mt-0.5 ${
                          isCompleted ? 'text-neutral-500 dark:text-neutral-400 dark:text-neutral-400' : 'text-neutral-300'
                        }`}>
                          {step.desc}
                        </span>
                      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <label className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 uppercase tracking-wider">Form Name</label>
                <p className="font-medium text-primary-900 dark:text-white break-words">{application.exam.title}</p>
              </div>
              <div>
                <label className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 uppercase tracking-wider">Category</label>
                <p className="font-medium text-primary-900 dark:text-white">{application.exam.category}</p>
              </div>
              <div>
                <label className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 uppercase tracking-wider">Description</label>
                <p className="text-sm text-neutral-600 dark:text-neutral-300 dark:text-neutral-300 break-words">{application.exam.description}</p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 uppercase tracking-wider">Last Date</label>
                ...
                <div>
                  <label className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 uppercase tracking-wider">Required Docs</label>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 uppercase tracking-wider">Applied On</label>
                ...
                <div>
                  <label className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 uppercase tracking-wider">Last Updated</label>
                  <p className="font-medium text-primary-900 dark:text-white">
                  ...
                  <div className="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-3 space-y-2">
                    {Object.entries(parsedFormData).filter(([key]) => key !== 'documents' && key !== 'terms').map(([key, value]) => (
                      <div key={key} className="flex justify-between text-sm">
                        <span className="text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 capitalize">{key.replace(/([A-Z])/g, ' $1')}</span>
            ...
            <CardContent>
              {!application.documents || application.documents.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 text-sm">No documents uploaded</p>
                </div>
              ) : (
            ...
            <CardContent>
              ...
              <div className="space-y-3 mb-4">
                <div className="flex justify-between text-sm">
                  <span className="text-neutral-500 dark:text-neutral-400 dark:text-neutral-400">Official Fee</span>
                  <span className="font-medium text-primary-900 dark:text-white">₹{application.exam.officialFee / 100}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-neutral-500 dark:text-neutral-400 dark:text-neutral-400">Service Fee</span>
                  <span className="font-medium text-primary-900 dark:text-white">₹{application.exam.serviceFee / 100}</span>
                </div>
                <div className="border-t border-neutral-200 dark:border-neutral-700 dark:border-neutral-700 pt-3 flex justify-between">
              ...
              {application.payment ? (
                <div className={`rounded-lg p-4 ${
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-600 dark:text-neutral-300 dark:text-neutral-300">
                  ...
                  {application.payment.razorpayPaymentId && (
                    <div className="mt-3 text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 space-y-1">
                ...
                <div className="bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 dark:border-neutral-700 rounded-lg p-4 text-center">
                  <IndianRupee className="h-8 w-8 text-neutral-300 mx-auto mb-2" />
                  <p className="text-neutral-500 dark:text-neutral-400 dark:text-neutral-400 text-sm">No payment yet</p>
