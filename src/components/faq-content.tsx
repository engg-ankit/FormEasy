...
const FAQ_DATA = [
  { q: 'What is ClickNsit?', a: 'ClickNsit is your online cyber cafe! We help students fill and submit their exam application forms, college admissions, scholarships, and other government forms — just like a cyber cafe, but online from the comfort of their home.' },
  { q: 'How does ClickNsit work?', a: 'Simply browse available forms, select the one you need, fill in your details through our easy 5-step wizard, upload required documents, and pay the fee. Our team processes your form on the official portal within 24-48 hours.' },
  ...
  { q: 'Can I track my application?', a: 'Yes! Log in to your dashboard at clickandsit.vercel.app/dashboard to see real-time status updates — from submission to completion.' },
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-neutral-600">Everything you need to know about ClickNsit</p>
        </div>
