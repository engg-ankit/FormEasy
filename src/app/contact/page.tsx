...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      <PageHead title="Contact Us | FormEasy" description="Get in touch with FormEasy — we're here to help with your form filling needs." />
      <SiteNav />
            ...
            <Card>
              <CardContent className="p-5 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600">support@formeasy.com</p>
